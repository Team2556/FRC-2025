...
class AutoAlign(Command):
    def __init__(self, drivetrain: CommandSwerveDrivetrain, vision: VisionSubsystem):
        ...
        self.vision = vision
        self.tag_id = 7  # Default tag ID

        self.rotational_pid = PIDController(0.05000, 0.000000, 0.001000)
        self.x_pid = PIDController(0.400000, 0.000000, 0.000600)
        self.y_pid = PIDController(0.3, 0, 0)
        ...
        SmartDashboard.putNumber("Tag being tracked", 7)
    ...
    def execute(self):
        self.tag_id = SmartDashboard.getNumber("Tag being tracked", 7)
        ...
        SmartDashboard.putNumber("distToRobot", fiducial.dist_to_robot)
